...
%TEST_STAGE3B_PRE Validate isolated standard-derived diagnostic boundaries.
    ...
    placeholder=stage3b_pre_fair_sampling(bb0);assert(placeholder.not_used_in_current_observation_statistics&& ...
        strcmp(placeholder.status,'future_waveform_fairness_placeholder'),'Deferred fairness metadata failed.');
