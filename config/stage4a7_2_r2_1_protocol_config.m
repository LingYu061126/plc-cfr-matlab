function sc=stage4a7_2_r2_1_protocol_config(base,mode,output_root,stage_name)
%STAGE4A7_2_R2_1_PROTOCOL_CONFIG Independent off-grid/noisy validation.
    ...
    if nargin<3||isempty(output_root),output_root=fullfile(base.root_dir,'results','data','stage4a7_2_r2_1');end
    if nargin<4||isempty(stage_name),stage_name='Stage 4A.7.2-R.2.1';end
    sc.stage_name=stage_name;sc.results_data=fullfile(output_root,mode);sc.results_logs=fullfile(base.root_dir,'results','logs','stage4a7_2_r2_1');
    ...
    sc.method_selection.bootstrap_replicates=2000;sc.method_selection.bootstrap_seed=20262941;sc.method_selection.bootstrap_pair_ids={'margin','ratio'};
